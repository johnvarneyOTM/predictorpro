...
#define BORDER_COLOR [UIColor  colorWithRed:0.163 green:0.166 blue:0.176 alpha:1.0]
...
- (id)initWithFrame:(CGRect)frame {
	...
	{
		self.backgroundColor = UIColorFromRGB(0x515455);
		...
		arrowImage.image = [UIImage imageNamedFallbackToPng:@"whiteArrow"];
